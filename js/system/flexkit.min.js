...
for(var r=0;r<h.length;r++)b.push(h[r])}for(;n<b.length;n++)for(g=0;g<a.length;g++)b[n].addEventListener(a[g],function(a){e(a,a.target)},!1);return this};a.helper=e})(window,document);(function(a,d,b){function e(b){h=d.documentElement;b=b||{};var e=d.querySelector('[href*="themes"]').getAttribute("href");e.substring(e.indexOf("themes",10),0);var g=e.indexOf("themes")+7;k=e.substring(g,e.indexOf("/",g));this.name="flexkit";this.version="0.0.1";c=this;e=b.chooseBoxStyle||!1;if(b=b.loadScript)for(var g=0,m=a.location.href+"themes/"+k+"/js/plugin/",n;g<b.length;g++)n=b[g]+".min.js",helper.createEl("SCRIPT",["async","src:"+m+n]);if(e)for(e=d.querySelectorAll('[type="checkbox"]:not(.filed-upgrade):not(.icon):not(.hidden),[type="radio"]:not(.filed-upgrade):not(.icon):not(.hidden)'),
...
"loaded":"d-loaded")};e.prototype.getSpaceFromTop=function(){return a.pageYOffset||d.documentElement.scrollTop};e.prototype.isMobile=function(a){device.type&&(console.log("%s Mobile scripts loaded.","[flexkit]"),a())};e.prototype.isLang=function(a){return h.lang===(a||"").toLowerCase()?!0:d.documentElement.lang};a.flexkit={init:function(a){return c||new e(a)}}})(window,document);function _dialog(){$(".dialog-btn").each(function(){var a=$(this).data("dialog-element"),d=$(this).data("dialog-open")?$(this).data("dialog-open"):!1;$(a).dialog({autoOpen:d,modal:!0,maxHeight:$(window).height()-.1*$(window).height()})});$(document).on("click",".dialog-btn",function(){var a=$(this).data();dialogInit({el:a.dialogElement,func:a.dialogFunc,title:a.dialogTitle,width:a.dialogWidth,height:a.dialogHeight,effect:a.dialogEffect,classes:a.dialogClasses,autoOpen:a.dialogAutoopen,draggable:a.dialogDraggable,
